...
// Premium, Mobile-Optimized, Fully Functional
// ============================================
...
const buttons = $$('.btn, .btn-course, .btn-sidebar-cta');
...
window.addEventListener('load', () => {
    ...
    console.log('%c━━━━━━━━━━━━━━━━━━━━━━━━━━━━', 'color: #a8a9b4;');
    console.log('%c✓ Premium UI loaded', 'color: #10b981; font-size: 12px; font-weight: 600;');
    console.log('%c✓ All interactions ready', 'color: #10b981; font-size: 12px; font-weight: 600;');
    console.log('%c✓ Mobile-optimized', 'color: #10b981; font-size: 12px; font-weight: 600;');
    console.log('%c━━━━━━━━━━━━━━━━━━━━━━━━━━━━', 'color: #a8a9b4;');
});
    ...
    window.addEventListener('load', () => {
        setTimeout(() => {
            ...
            if (pageLoadTime < 2000) {
                ...
                console.log('%c⚠️ Consider optimization', 'color: #f59e0b; font-size: 12px;');
            }
        }, 0);
    });
}
...
window.addEventListener('resize', debounce(() => {
    // Re-initialize animations on orientation change
    updateActiveNav();
}, 250));
...
window.addEventListener('online', () => {
    console.log('%c✓ Connection restored', 'color: #10b981; font-weight: 600;');
});

window.addEventListener('offline', () => {
    console.log('%c⚠️ Connection lost', 'color: #f59e0b; font-weight: 600;');
});
...
console.log('%c🎨 Premium UI by Foxbite', 'color: #a8a9b4; font-size: 10px; font-style: italic;');
